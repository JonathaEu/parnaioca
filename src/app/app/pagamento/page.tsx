...
import sistemas from '../../../../public/assets/sistemas-corporativos.png';
    ...
    return (
        ...
        <>
            <SideBarFuncionario>
                ...
                <div className=" bg-cover flex items-center content-center justify-center h-screen w-full bg-slate-200">
                    <div>
